...
| **Screen saver** | After a minute with no messages the screen turns off, and every 30 s it shows a 5 s animation of particles with fading trails: they gather around the clock and date, then burst away. Any press or new message wakes it. The CPU runs at 160 MHz, 80 MHz while the screen is off. |
